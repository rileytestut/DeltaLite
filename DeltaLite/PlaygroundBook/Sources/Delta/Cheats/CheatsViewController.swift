...
class CheatsViewController: UITableViewController
{
    ...
    private let dataSource = RSTFetchedResultsTableViewDataSource<NESCheat>(fetchedResultsController: NSFetchedResultsController())
}
...
private extension CheatsViewController
{
    ...
    {
        let fetchRequest: NSFetchRequest<NESCheat> = NESCheat.fetchRequest()
        fetchRequest.returnsObjectsAsFaults = false
        fetchRequest.predicate = NSPredicate(format: "%K == %@", #keyPath(NESCheat.game), self.game)
        fetchRequest.sortDescriptors = [NSSortDescriptor(key: #keyPath(NESCheat.name), ascending: true)]
...
private extension CheatsViewController
{
    ...
    func deleteCheat(_ cheat: NESCheat)
    {
...
private extension CheatsViewController
{
    ...
    func makeEditCheatViewController(cheat: NESCheat?) -> EditCheatViewController
    {        
...
extension CheatsViewController
{
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        backgroundContext.performAndWait {
            let temporaryCheat = backgroundContext.object(with: cheat.objectID) as! NESCheat
...
{
    func editCheatViewController(_ editCheatViewController: EditCheatViewController, activateCheat cheat: NESCheat, previousCheat: NESCheat?)
    {
    ...
    func editCheatViewController(_ editCheatViewController: EditCheatViewController, deactivateCheat cheat: NESCheat)
    {
        self.delegate?.cheatsViewController(self, deactivateCheat: cheat)
    }
}
