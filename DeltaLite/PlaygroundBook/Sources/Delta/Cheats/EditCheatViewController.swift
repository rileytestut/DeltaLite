...
class EditCheatViewController: UITableViewController
{
    ...
    private var mutableCheat: NESCheat!
...
extension EditCheatViewController
{
    override func viewDidLoad()
    {
        ...
        self.managedObjectContext.performAndWait {
            ...
            {
                self.mutableCheat = self.managedObjectContext.object(with: cheat.objectID) as? NESCheat
            }
            else
            {
                self.mutableCheat = NESCheat.insertIntoManagedObjectContext(self.managedObjectContext)
                self.mutableCheat.game = self.managedObjectContext.object(with: self.game.objectID) as? NESGame
...
private extension EditCheatViewController
{
    ...
    func validateCheat(_ cheat: NESCheat) throws
    {
