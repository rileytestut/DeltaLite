...
class PausePresentationController: UIPresentationController
{
    ...
    override var frameOfPresentedViewInContainerView: CGRect
    {
        ...
        if contentHeight == 0
        {
            let statusBarHeight = UILayoutGuide.liveViewSafeArea?.containingViewInsets.top ?? 0
        ...
        else
        {
            ...
            frame.origin.y -= UILayoutGuide.liveViewSafeArea?.containingViewInsets.bottom ?? 0
        }
    ...
    init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?, presentationAnimator: UIViewPropertyAnimator)
    {
        ...
        self.pauseIconImageView.image = self.pauseIconImageView.image?.withRenderingMode(.alwaysTemplate)
    }
